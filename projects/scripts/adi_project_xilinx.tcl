...
proc adi_project_run {project_name} {
  ...
  if { [string match "*VIOLATED*" $timing_string] == 1 ||
    ...
    write_sysdef -force -hwdef $project_name.runs/impl_1/system_top.hwdef -bitfile $project_name.runs/impl_1/system_top.bit $project_name.sdk/system_top_bad_timing.hdf
    return -code error [format "ERROR: Timing Constraints NOT met!"]
  } else {
    write_sysdef -force -hwdef $project_name.runs/impl_1/system_top.hwdef -bitfile $project_name.runs/impl_1/system_top.bit $project_name.sdk/system_top.hdf
  }
}
